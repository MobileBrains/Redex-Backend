...
ActiveRecord::Schema.define(version: 20180519225743) do
  ...
  create_table "devolutions", force: :cascade do |t|
    ...
    t.index ["delivery_order_id"], name: "index_devolutions_on_delivery_order_id", using: :btree
  end

  create_table "mail_delivery_companies", force: :cascade do |t|
    t.string   "name"
    t.string   "address"
    t.string   "email"
    t.integer  "phone"
  ...
  create_table "mail_delivery_offices", force: :cascade do |t|
    t.string   "name"
    t.string   "address"
    t.string   "email"
    t.integer  "phone"
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.integer  "mail_delivery_company_id"
  end

  create_table "management_reports", force: :cascade do |t|
    t.string   "name"
    t.string   "link"
